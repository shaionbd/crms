...
var $social_inputs = $('#social_link_form :input');
$social_inputs.on('keyup change', function() {

    var dataChanged = $social_inputs.filter(function() {
        if ($(this).is(':checkbox')) {
    ...
    if (dataChanged == 0) {
        $('#save_social_link').hide('slow');
    } else { 
        $('#save_social_link').show('slow');
    }
});

var $banner_inputs = $('#banner_form :input');
$banner_inputs.on('keyup change', function() {

    var dataChanged = $banner_inputs.filter(function() {
        if ($(this).is(':checkbox')) {
            var originalValue = this.defaultChecked;
            var currentValue = this.checked;
        } else {
    ...
    if (dataChanged == 0) {
        $('#save_banner').hide('slow');
    } else { 
        $('#save_banner').show('slow');
    }
});